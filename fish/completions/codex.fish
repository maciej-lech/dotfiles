...
function __fish_codex_global_optspecs
	string join \n c/config= enable= disable= i/image= m/model= oss local-provider= p/profile= s/sandbox= a/ask-for-approval= full-auto dangerously-bypass-approvals-and-sandbox C/cd= search add-dir= h/help V/version
end
...
complete -c codex -n "__fish_codex_using_subcommand mcp; and not __fish_seen_subcommand_from list get add remove login logout help" -f -a "login" -d '[experimental] Authenticate with a configured MCP server via OAuth. Requires features.rmcp_client = true in config.toml'
complete -c codex -n "__fish_codex_using_subcommand mcp; and not __fish_seen_subcommand_from list get add remove login logout help" -f -a "logout" -d '[experimental] Remove stored OAuth credentials for a server. Requires features.rmcp_client = true in config.toml'
...
complete -c codex -n "__fish_codex_using_subcommand mcp; and __fish_seen_subcommand_from help" -f -a "login" -d '[experimental] Authenticate with a configured MCP server via OAuth. Requires features.rmcp_client = true in config.toml'
complete -c codex -n "__fish_codex_using_subcommand mcp; and __fish_seen_subcommand_from help" -f -a "logout" -d '[experimental] Remove stored OAuth credentials for a server. Requires features.rmcp_client = true in config.toml'
...
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "macos" -d 'Run a command under Seatbelt (macOS only)'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "seatbelt" -d 'Run a command under Seatbelt (macOS only)'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "linux" -d 'Run a command under Landlock+seccomp (Linux only)'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "landlock" -d 'Run a command under Landlock+seccomp (Linux only)'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "windows" -d 'Run a command under Windows restricted token (Windows only)'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from macos seatbelt linux landlock windows help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from macos" -l log-denials -d 'While the command runs, capture macOS sandbox denials via `log stream` and print them after exit'
...
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from seatbelt" -l log-denials -d 'While the command runs, capture macOS sandbox denials via `log stream` and print them after exit'
...
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from windows" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as TOML. If it fails to parse as TOML, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from windows" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from windows" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from windows" -l full-auto -d 'Convenience alias for low-friction sandboxed automatic execution (network-disabled sandbox that can write to cwd and TMPDIR)'
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from windows" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c codex -n "__fish_codex_using_subcommand debug; and __fish_seen_subcommand_from help" -f -a "windows" -d 'Run a command under Windows restricted token (Windows only)'
...
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as TOML. If it fails to parse as TOML, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -s V -l version -d 'Print version'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -f -a "exec" -d 'Submit a new Codex Cloud task without launching the TUI'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -f -a "status" -d 'Show the status of a Codex Cloud task'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -f -a "apply" -d 'Apply the diff for a Codex Cloud task locally'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -f -a "diff" -d 'Show the unified diff for a Codex Cloud task'
complete -c codex -n "__fish_codex_using_subcommand cloud; and not __fish_seen_subcommand_from exec status apply diff help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand cloud; and __fish_seen_subcommand_from exec" -l branch -d 'Git branch to run in Codex Cloud' -r
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "review" -d 'Run a code review non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "mcp" -d '[experimental] Run Codex as an MCP server and manage MCP servers'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "mcp-server" -d '[experimental] Run the Codex MCP server (stdio transport)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "execpolicy" -d 'Execpolicy tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "cloud" -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume cloud responses-api-proxy stdio-to-uds features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand help; and __fish_seen_subcommand_from mcp" -f -a "login" -d '[experimental] Authenticate with a configured MCP server via OAuth. Requires features.rmcp_client = true in config.toml'
complete -c codex -n "__fish_codex_using_subcommand help; and __fish_seen_subcommand_from mcp" -f -a "logout" -d '[experimental] Remove stored OAuth credentials for a server. Requires features.rmcp_client = true in config.toml'
